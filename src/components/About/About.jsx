...
const About = () => {
  ...
  return (
    <section
      id="about"
      // className={`${styles.section} animate__animated animate__fadeInDown`}
    ...
    >
      <div className={styles.aboutcontainer}>
        <h2>Sobre Mi</h2>
        <p>
          ¡Hola! Soy Carlos Mendoza, un apasionado de la naturaleza y los
          desafíos al aire libre. Me encanta explorar las montañas y descubrir
          nuevos paisajes que la madre naturaleza tiene para ofrecer. Con cada
          ascenso, encuentro una conexión única con el entorno y una sensación
          de logro que solo los amantes de la montaña entenderán.
        </p>
        <p>
